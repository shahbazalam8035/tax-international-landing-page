...
const Footer = () => {
  return (
    <div className="w-full container mx-auto">
        <div className='px-6 py-[40px] flex flex-col gap-4'>
            <div className='flex justify-between'>
          <div className="flex lg:gap-[34px] gap-3 justify-start text-[16px] leading-[100%] text-[#424242] lg:flex-row flex-col font-semibold">
