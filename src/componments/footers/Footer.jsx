  ...
  return (
    <div className="w-full container mx-auto">
        <div className='px-6 py-[40px] flex flex-col gap-[20px]'>
          ...
          <div className="flex lg:gap-[34px] gap-3 justify-start text-[19.7px] leading-[100%] text-[#424242] lg:flex-row flex-col font-bold">
        ...
        <div>
          <p className="lg:text-start text-center text-[#2b1845] text-[19.7px] leading-[100%] font-bold">
