  ...
  const cardData = [
    {
      ...
      challenge: "Ensuring consistent hiring practices across multiple sites while meeting NRC (Nuclear Regulatory Commission) requirements for role suitability and documentation.",
    ...
    <div className="bg-[#FFFFFF] flex justify-center">
      ...
      <h2 className="font-semibold text-[30px] leading-[150%] text-[#502F99] text-left lg:hidden block">
        ...
        <motion.img
          ...
          alt=""
          className="lg:h-[531px] md:h-[400px]  h-auto rounded-xl object-cover"
          whileHover={{
            scale: 1.05,
        ...
        <div className="flex flex-col gap-5">
          <div className="">
            <h2 className="font-semibold lg:text-[40px] text-[30px] leading-[150%] text-[#502F99] text-center lg:text-left lg:block hidden mb-[16px]">
              What Makes SmartHire Different for the Nuclear Sector
            </h2>
            ...
            {cardData.map((card, index) => (
              ...
              >
                <div className="flex justify-between gap-1">
                  ...
                  <FaArrowRight style={{ fontSize: "20px", color: "#502F99" }} />
                </div>
                <div>
                  <h6 className="font-bold text-[16px] leading-[150%] text-[#424242] mt-4">
                    Challenge:
                  </h6>
                ...
                {showModal && activeCard && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="lg:p-[60px] p-[20px] flex flex-col h-full space-y-[40px] max-h-[80vh] overflow-y-auto  ">
                                <div>
                                    <h2 className="lg:text-[36px] text-[20px] leading-[150%] font-semibold text-[#864EFF] mb-3">
                                        {activeCard.country}
                                    </h2>
                                    <div className='text-[#17181F] lg:text-[24px] text-[18px] leading-[150%] font-medium'>  <span>Challenge:</span>{activeCard.challenge}</div>
                                </div>
                                <div className='bg-[#F4F4F4] lg:p-[40px] p-[20px] rounded-xl'>
                                    <h3 className='text-[#1D1D1F] font-medium lg:text-[26px] text-[18px] leading-[120%] mb-[10px]'>Solution:</h3>
                                    <p className="lg:text-[20px] text-[16px] text-[#1D1D1F] medium leading-[120%] space-y-1 "> {activeCard.solution}</p>
                                </div>
                                <div>
                                <h3 className='text-[#502F99] text-[18px] leading-[120%] font-semibold mb-2'>Impact:</h3>
